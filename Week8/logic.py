...
kb.tell("A")
print(kb.clauses)
print(kb.ask_if_true(A))
print(kb.ask_if_true(E))
kb.tell("E | F")
print(kb.clauses)
print(kb.ask_if_true(A & C))
kb.tell("~E")
print(kb.ask_if_true(A & F))
kb.tell("A ==> Z")
print(kb.clauses)
kb.tell("A")
print(kb.clauses)
# print(kb.ask_if_true(Z))

kb.tell(expr('~(P & Q)  ==>  (~P | ~Q)'))
print(kb.clauses)
kb.tell("P")
print(kb.clauses)
kb.tell(expr('P ==> Q'))
print(kb.clauses)
print(kb.ask_if_true(Q))
print(kb.ask_generator(A))
agentX = KB_AgentProgram(kb)
print(agentX)

#print(pl_resolution(kb, Q))
#print(kb.pl_resolution(Q))
...
kb3.tell(expr('Y ==> Z'))
#tt_entails(agentX, Q)
kb3.clauses_with_premise(X)
# kb3.clauses_with_premise(P)
pl_fc_entails(kb3, Z)"""
